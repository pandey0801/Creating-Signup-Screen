...
//     // fetch("https://react-http-af8d1-default-rtdb.firebaseio.com/profile.json", {
//       // https://expensetrackerv1-eb334-default-rtdb.firebaseio.com/
//       fetch("https://expensetrackerv1-eb334-default-rtdb.firebaseio.com/profile.json", {
//       method: "GET",
//       headers: {
//         "Content-Type": "application/json",
...
//       alert("Ckeck you Mail")
//   };

//   return (
//     <div className={`min-h-screen p-6 ${theme  ? "bg-gray-800" : "bg-white"}`}>
//       <div className="flex justify-between items-center bg-white shadow p-6 rounded-md">
...
//               < GiRamProfile className="text-gray-900 mr-3 size-9" />
...
//             </div>
//             <div className="flex items-center">
//               <FcContacts className="text-gray-500 mr-3 size-8" />
...
//             <div
//               key={index}
//               className="bg-white shadow p-4 rounded-md mb-4 space-y-2"
//             >
//               <p className="font-medium">Name: {item.name}</p>
//               <p className="text-gray-600">Profile: {item.profile}</p>
//             </div>
//           ))}
//         </div>
//       </div>
